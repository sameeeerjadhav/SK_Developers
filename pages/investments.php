...
const INVESTMENT_FIXED_SLUGS = ['investment'];
const INVESTMENT_REGULAR_SLUGS = ['daily_credit', 'monthly_credit', 'investment_withdrawal'];
    ...
    <div class="card investment-section investment-section-fixed">
      <div class="investment-section-head">
        ...
        <div>
          ...
          <div class="investment-section-sub">Long-term capital — invested for years, rarely moves.</div>
        </div>
