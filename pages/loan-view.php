...
if (in_array($exportAction, ['csv', 'excel', 'pdf'], true)) {
    ...
    if ($exportAction === 'csv') {
        ...
        fputcsv($out, ['Total loan amount', $amt($loan['loan_amount'])]);
        fputcsv($out, ['Total outstanding', $amt($loan['outstanding_amount'])]);
        fputcsv($out, ['Interest + charges', $amtOrBlank($loan['interest_charges'])]);
    ...
    if ($exportAction === 'excel') {
        ...
        echo $row([$cell('BANK LOAN REPORT', 'String', 'DocTitle')]);
        ...
        echo $row([$cell('Total loan amount', 'String', 'Label'), $cell($loan['loan_amount'], 'Number', 'Money')]);
        echo $row([$cell('Total outstanding', 'String', 'Label'), $cell($loan['outstanding_amount'], 'Number', 'Money')]);
        echo $row([$cell('Interest + charges', 'String', 'Label'), $loan['interest_charges'] !== null ? $cell($loan['interest_charges'], 'Number', 'Money') : $cell('')]);
